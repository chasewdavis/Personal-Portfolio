    ...
    render(){
        return(
            ...
            <div className='fixed-right-navbar'>
                ...
                <button onClick={()=>{jump('#one', {offset:-48, duration: distance => Math.abs(distance*.75)})}} className={this.props.section===1?'highlight-btn about-btn':'unhighlight-btn about-btn'}>Home</button>
